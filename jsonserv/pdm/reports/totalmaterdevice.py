# Отчет Сводная ведомость материалов по изделиям
...
class ReportClass(BaseReportClass):
    ...
    def __init__(self, request):
        ...
        self.file_name = "Сводная ведомость материалов по изделиям.xls"
        ...
        self.norma_style.num_format_str = '# ##0.00'
        ...
        self.prepare_sql_params({"object_id": 1844, "quantity": 1, "group_id": ''})

        self.sql_file = get_sql_file_path('pdm', 'total_mater_device.sql')
